...
export const dict = {
  ...
  ko: {
    ...
    publicationData: [
      { slug: 'aes-multilayer-encoders', title: 'Automated Essay Scoring based on Multi-layer Encoders', authors: 'Jo, J., et al.', venue: "EMNLP", date: '2026', details: 'EMNLP 2026 심사 중. 학생 에세이의 계층적 창 의성과 일관성을 포착하기 위해 다층 인코더 아키텍처를 활용한 새로운 자동 채점 프레임워크를 제안합니다.', href: 'https://openreview.net/forum?id=D1gIWlY4tp&referrer=%5Bthe%20profile%20of%20Joonyoung%20Jo%5D(%2Fprofile%3Fid%3D~Joonyoung_Jo1)',, logo: '/media/Gemini_Generated_Image_tz1hvgtz1hvgtz1h.png', sidebarMedia: [{ src: '/media/screenshot-2026-04-14-am-11.57.06.png', alt: 'AES Detail 1' }, { src: '/media/screenshot-2026-04-14-am-11.57.29.png', alt: 'AES Detail 2' }, { src: '/media/screenshot-2026-04-14-am-11.57.49.png', alt: 'AES Detail 3' }] },
      ...
      { slug: 'offroad-farm-robot-2023', title: '농업 환경에서의 자율주행 로봇 개발을 위한 오프로드 주행환경이 고려된 심층 강화학습 프레임워크', authors: 'Jo, J., et al.', venue: 'KIIT Conference', logo: '/media/kiit_logo.png', date: '2023년 11월', details: '비정형 오프로드 환경에서의 농업용 수확 로봇 자율주행을 위해 Unity 기반의 강화학습 시뮬레이션을 설계하고, 논문경진대회 우수논문상 (금상)', href: 'https://www.dbpia.co.kr/journal/articleDetail?nodeId=NODE11651891', sidebarMedia: [{ src: '/media/screenshot-2026-04-13-pm-9.38.54.png', alt: 'Off-road RL' }, { src: '/media/screen-record-2023-06-02-am-3.18.17.gif', alt: 'Evaluation' }, { src: '/media/screenshot-2026-04-13-pm-9.39.02.png', alt: 'Off-road robot' }] },
